...
SET @Employee_Role_Id  = (UUID_TO_BIN('cee65bf3-0bfa-41fb-8921-845385ec4694', true));
...
INSERT INTO Roles(Id, Authority) VALUES(@User_Role_Id, 'USER'),(@Admin_Role_Id,'ADMIN'),(@Employee_Role_Id, 'EMPLOYEE');
INSERT INTO Users_Roles(User_Id,Role_Id) VALUES(@Zun_Id,@Admin_Role_Id),(@Zun_Id,@User_Role_Id),(@Zun_Id,@Employee_Role_Id);